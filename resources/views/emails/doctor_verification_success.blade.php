...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-50">
        <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-lg text-center">
            ...
            <p class="text-lg text-gray-700 mb-6">Thank you for verifying your email address. You can now <a href="{{ config('app.front_url') }}/doctor/login" class="text-blue-500 hover:text-blue-700 font-semibold">log in</a> to your account.</p>
